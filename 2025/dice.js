...
const DICE = (function() {
    ...
    threeD_dice.create_d4 = function() {
        ...
        if (!this.d4_material) this.d4_material = new THREE.MeshFaceMaterial(
                create_d4_materials(vars.scale / 2, vars.scale * 2, CONSTS.d4_labels[0], color_index++));
    ...
    threeD_dice.create_d6 = function() {
        ...
        if (!this.d6_material) this.d6_material = new THREE.MeshFaceMaterial(
                create_dice_materials(CONSTS.standart_d20_dice_face_labels, vars.scale / 2, 0.9, color_index++));
    ...
    threeD_dice.create_d8 = function() {
        ...
        if (!this.d8_material) this.d8_material = new THREE.MeshFaceMaterial(
                create_dice_materials(CONSTS.standart_d20_dice_face_labels, vars.scale / 2, 1.4, color_index++));
    ...
    //    if (!this.d_material) this.dice_material = new THREE.MeshFaceMaterial(
    ...
    threeD_dice.create_d10 = function() {
        ...
        if (!this.d10_material) this.d10_material = new THREE.MeshFaceMaterial(
                create_dice_materials(CONSTS.standart_d20_dice_face_labels, vars.scale / 2, 1.0, color_index++));
    ...
    threeD_dice.create_d20 = function() {
        ...
        if (!this.d20_material) this.d20_material = new THREE.MeshFaceMaterial(
                create_dice_materials(CONSTS.standart_d20_dice_face_labels, vars.scale / 2, 1.2, color_index++));
    ...
    function create_dice_materials(face_labels, size, margin, color_index) {
        ...
        for (var i = 0; i < face_labels.length; ++i)
            materials.push(new THREE.MeshPhongMaterial($t.copyto(vars.material_options,
                        { map: create_text_texture(face_labels[i], vars.label_color, vars.dice_colors[color_index % 2]) })));
        return materials;
    }

    function create_d4_materials(size, margin, labels, color_index) {
        ...
        for (var i = 0; i < labels.length; ++i)
            materials.push(new THREE.MeshPhongMaterial($t.copyto(vars.material_options,
                        { map: create_d4_text(labels[i], vars.label_color, vars.dice_colors[color_index % 2]) })));
        return materials;
    }
